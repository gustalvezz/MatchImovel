        ...
        {curatingMatch === match.id ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <Button
                onClick={() => onCurate(match.id, true)}
              ...
              <Button
                onClick={() => onCurate(match.id, false)}
                variant="destructive"
      ...
      <div className="border-t pt-4 space-y-4">
        ...
        {schedulingVisit === match.id ? (
          <div className="bg-blue-50 p-4 rounded-xl space-y-4">
            ...
            <div className="flex gap-3">
              <Button
                onClick={() => onScheduleVisit(match.id)}
            ...
            {pendingMatches.length === 0 ? (
              ...
              pendingMatches.map((match) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                >
                  <MatchCard match={match} showActions={true} {...cardProps} />
                </motion.div>
              ))
            )}
          </TabsContent>
            ...
            {myMatches.length === 0 ? (
              ...
              myMatches.map((match) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                >
                  <MatchCard match={match} showActions={false} {...cardProps} />
                </motion.div>
              ))
            )}
          </TabsContent>
